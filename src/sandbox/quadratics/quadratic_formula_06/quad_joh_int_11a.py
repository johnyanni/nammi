...
class QuadraticFormulaScrollManager(MathTutorialScene):
    def construct(self):
        ...
        # Position all steps
        all_steps = VGroup(starting_eq, step1, step2,step2_extend, step3, step4, step5)
        step2_extend.next_to(step2, DOWN, buff=2.5)
        ...
        all_elements = self.unpack_steps_for_scroll_manager(
            starting_eq, step1, step2, step2_extend, step3, step4, step5
        )
