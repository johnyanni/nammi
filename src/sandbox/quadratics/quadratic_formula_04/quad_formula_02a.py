...
class QuadraticFormula(MathTutorialScene):
    def construct(self):
        ...
        step2 = VGroup(step2_label, step2_expr1, div_4, step2_expr2).arrange(DOWN, aligned_edge=LEFT, buff=ELEMENT_BUFF)
        ...
        # Create the complete step
        step4 = VGroup(step4_label, step4_expr1, subtract_12, step4_expr2).arrange(DOWN, aligned_edge=LEFT, buff=ELEMENT_BUFF)
