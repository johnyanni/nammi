...
SLOPE = 2
Y_INTERCEPT = -4                    
EQUATION_FORMATTED = "y = 2x - 4"  


# Display and spoken representations
SLOPE_DISPLAY = "2"
SLOPE_SPOKEN = "two"  
Y_INTERCEPT_DISPLAY = "4"  # without a sign
Y_INTERCEPT_SPOKEN = "four" # without a sign
SPOKEN_EQUATION = "y equals two x minus four"
...
class DeterminePoint02a(MathTutorialScene):
