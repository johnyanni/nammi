...
TEMPLATE_PARAMS = {
    ...
    "equation": {
        "slope": 3/2,                      # The slope value as a fraction
        "y_intercept": -4,                 # The y-intercept value as a number
        "formatted": "y=\\frac{3}{2}x-4",  # Formatted equation with LaTeX
    },
    
    # Display and spoken representations
    "display": {
        "slope_display": "\\frac{3}{2}",   # How the slope appears in LaTeX
        "slope_spoken": "three halves",    # How the slope should be spoken in voiceover
        "y_intercept_display": "-4",       # How the y-intercept appears in LaTeX
        "y_intercept_spoken": "negative four", # How the y-intercept should be spoken
        "spoken_equation": "y equals three halves x minus four",  # Spoken version for voiceover
    },
    ...
    "indices": {
        ...
        "coord_src_indices": [-6, None],       # Source indices for coordinates
        "coord_tgt_indices": [-6, None]        # Target indices for coordinates
    },
    
    # Coordinate points and visual ranges
    "geometry": {
        "y_intercept_point": [0, -4],      # Coordinates of y-intercept point
        "second_point": [2, -1],           # Coordinates of second point (run 2, rise 3)
        "axes_range": [-2, 10, 1],         # Specific range for axes as requested: [min, max, step]
        "x_line_range": [0, 4],            # X-range for plotting the line
    },
    
    # Rise and run values for slope visualization
    "rise_run": {
        "rise_value": 3,                   # Simple rise value (slope numerator)
        "rise_spoken": "three",            # Spoken version of rise value
        "run_value": 2,                    # Simple run value (slope denominator)
        "run_spoken": "two",               # Spoken version of run value
    ...
    "ui": {
        "tip_message": "When the slope (m) is a positive fraction, the rise is greater than the run.",
