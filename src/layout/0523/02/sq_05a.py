...
class SQ1(MathTutorialScene):
    def construct(self):
        ...
        calc3_c2_equals = calculation_step3[0][2:5]
        ...
        elements = VGroup(
            ...
            calc3_sqrt,        # Index 13  
            calc3_c2_equals,   # Index 14
            calc3_sqrt2,       # Index 15
            calc3_125,         # Index 16
            
            calc4_c_equals,    # Index 17
            calc4_11_18        # Index 18
        )
        ...
        #calculation_step2
        scroll_mgr.fade_in_from_target(self, calc1_c2_equals)
        scroll_mgr.fade_in_from_target(self, VGroup(calc1_25, calc1_plus, calc1_100))
        
        #calculation_step3
        scroll_mgr.prepare_next(self)
        scroll_mgr.fade_in_from_target(self, calc2_c2_equals)
        scroll_mgr.prepare_next(self)
        scroll_mgr.fade_in_from_target(self, calc2_125)
        
        # #calculation_step4
        scroll_mgr.fade_in_from_target(self, calc3_c2_equals)
        scroll_mgr.fade_in_from_target(self, calc3_125)
