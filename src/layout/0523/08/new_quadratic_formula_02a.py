...
class NEWQuadraticFormula01(MathTutorialScene): 
    def construct(self):
        ...
        divide_step = scroll.create_and_position_step(
        ...
        expand_step = scroll.create_and_position_step(
        ...
        subtract_step = scroll.create_and_position_step(
        ...
        identify_coefficients_step = scroll.create_and_position_step(
        ...
        # sol3_step1 = scroll.create_and_position_step(
        ...
        # sol3_step2 = scroll.create_and_position_step(
        ...
        # sol3_step5 = scroll.create_and_position_step(
        ...
        # sol3_step6 = scroll.create_and_position_step(
