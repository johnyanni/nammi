...
class NEWQuadraticFormula01(MathTutorialScene): 
    def construct(self):
        ...
        scroll.set_position_target(question_text, DOWN, buff=0.4, align_edge=LEFT)
        ...
        divide_step = scroll.construct_step(
            ...
            scroll.create_math_tex(r"(x+5)^2 = 12", label="m_divided_by_4_result")
        )
        ...
        scroll.prepare_next("m_divided_by_4_result")
