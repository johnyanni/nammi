...
class SQuadraticFormula01(MathTutorialScene): 
    def construct(self):
        ...
        scroll.replacement_transform_copy(coefficient_values['b_value'], visible_copies.b_in_frac)
        scroll.replacement_transform_copy(coefficient_values['b_value'], visible_copies.b_in_sqrt)
