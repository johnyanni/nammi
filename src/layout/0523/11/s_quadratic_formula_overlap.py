...
class RQuadraticFormula01(MathTutorialScene): 
    def construct(self):
        ...
        substituted_values = self.parse_elements(s6_substitute_values_step[1],
            ('b_in_frac', '10', 0, B_COLOR),
            ('b_in_sqrt', '10', 1, B_COLOR),
            ('a_in_4ac', '1', 2, A_COLOR),
            ('c_in_4ac', '13',0, C_COLOR),
            ('a_in_denom', '1', -1, A_COLOR)
        )
        
        scroll.create_steps(s6_substitute_values_step, ["l_substitute_values", "m_substitute_values"], arrange=False)
        
        # ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        
        scroll.prepare_next("l_substitute_values")
        scroll.prepare_next("m_substitute_values")
        ...
        # scroll.fade_in_from_target(coefficient_values['b_value'], substituted_values['b_in_frac'])
        # scroll.fade_in_from_target(coefficient_values['b_value'], substituted_values['b_in_sqrt'])
        
        # scroll.transform_from_copy(coefficient_values['b_value'], substituted_values['b_in_frac'])
        # scroll.transform_from_copy(coefficient_values['b_value'], substituted_values['b_in_sqrt'])
        
        
        #other solution was self.play - replacementtransform()
        #transformfromcopy() didnt work when self.play
        
        # scroll.replacement_transform_copy(
        #     coefficient_values['b_value'],
        #     substituted_values['b_in_frac']
        # )
        ...
        scroll.replacement_transform_copy(s8_sqrt_48['sqrt_48'], sqrt_48_parts['sqrt_48'])
