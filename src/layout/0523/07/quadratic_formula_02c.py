...
class QuadraticFormula02a(MathTutorialScene):
    def construct(self):
        ...
        with self.voiceover(
            ...
            We have four. times the quantity x plus five squared equals forty-eight."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""Let's divide both sides by four. to simplify."""
        ) as tracker:
            scroll.prepare_next(run_time=2)  # Show label
            
        with self.voiceover(
            text="""We divide four. by four. to get one, and forty-eight by four. to get twelve.
            This gives us x plus five squared equals twelve."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""X plus five squared means x plus five times x plus five."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""Using FOIL, we get x squared plus ten x plus twenty-five equals twelve."""
        ) as tracker:
            scroll.prepare_next(run_time=2)  # Show result
        ...
        with self.voiceover(
            text="""Let's subtract twelve from both sides.
            This gives us x squared plus ten x plus thirteen equals zero. 
            <bookmark mark="A"/>
        ...
        with self.voiceover(
            text="""The coefficient of x is ten."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""And the constant term is thirteen."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""We replace b with ten, appearing twice in the formula."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""Negative ten stays as negative ten. 
            Ten squared is one hundred. 
            Four. times one times thirteen is fifty-two. 
        ...
        with self.voiceover(
            text="""One hundred minus fifty-two equals forty-eight."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""Now we need to simplify the square root of forty-eight."""
        ) as tracker:
            scroll.prepare_next(run_time=2)  # Show label
            self.play(self.indicate(simplify2_sqrt, run_time=2))
            
        with self.voiceover(
            text="""We can factor forty-eight as sixteen times three."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""Since the square root of sixteen is four., 
            we get four. times the square root of three."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""On the left side of the fraction, negative ten divided by two is negative five."""
        ) as tracker:
        ...
        with self.voiceover(
            text="""On the right, four. divided by two is two, so we get two times the square root of three."""
        ) as tracker:
            scroll.transform_from_copy(
        ...
        with self.voiceover(
            text="""So our solution is x equals negative five plus or minus two times the square root of three."""
        ) as tracker:
            self.wait(1)
        ...
        with self.voiceover(
            ...
            negative five minus two times the square root of three."""
        ) as tracker:
            self.play(
        ...
        with self.voiceover(
            text="""Which equals approximately negative eight point four six four."""
        ) as tracker:
            self.play(Write(answer1_decimal, run_time=2))
            
        with self.voiceover(
            text="""For the second solution, we add: 
            negative five plus two times the square root of three, which equals approximately negative one point five three six."""
        ) as tracker:
