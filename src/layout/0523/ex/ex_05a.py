...
class ProblematicExample(MathTutorialScene):
    def construct(self):
        ...
        step1.arrange(DOWN, aligned_edge=LEFT, buff=0.3)

        step1.next_to(step5, DOWN, buff=0.5, aligned_edge=LEFT)
        ...
        s6_identify_coefficients_step = scroll.construct_step_2(
