...
class SQ1(MathTutorialScene):
    def construct(self):
        ...
        #substitute
        scroll_mgr.transform_match(self, formula_c2_equals)
        scroll_mgr.transform_match(self, formula_a)
        scroll_mgr.transform_match(self, formula_a_squared)
        scroll_mgr.transform_match(self, formula_plus)
        scroll_mgr.transform_match(self, formula_b)
        scroll_mgr.transform_match(self, formula_b_squared)
        
        #calculation_step1
        scroll_mgr.transform_match(self, sub_c2_equals)
        scroll_mgr.transform_match(self, VGroup(sub_5, sub_5_squared))
        scroll_mgr.transform_match(self, sub_plus)
        scroll_mgr.transform_match(self, VGroup(sub_10, sub_10_squared))
        
        #calculation_step2
        scroll_mgr.transform_match(self, calc1_c2_equals)
        scroll_mgr.transform_match(self, VGroup(calc1_25, calc1_plus, calc1_100))
        
        #calculation_step3
        scroll_mgr.prepare_next(self)
        scroll_mgr.transform_match(self, calc2_c2_equals)
        scroll_mgr.prepare_next(self)
        scroll_mgr.prepare_next(self)
        scroll_mgr.transform_match(self, calc2_125)
        
        # #calculation_step4
        scroll_mgr.transform_match(self, calc3_c2_equals)
        scroll_mgr.transform_match(self, calc3_125)
